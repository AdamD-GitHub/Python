...
print("======================================")
print("- Dictonaries")
print("-    Retrieved by key name - don't need to know index")
print("-    Unordered and can not be sorted")
print("======================================")
print("--- 1") #print value
...
print("-    Similar to list, but have immutability")
print("-    Tuple us PARENTHESIS, not braces")
